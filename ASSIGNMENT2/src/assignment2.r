...
diabetes = read.csv("C://Users//sailo//OneDrive//Desktop//PDS//ASSIGNMENT2//cleandata//diabetes.csv")
diabetes
...
hist(bmi, breaks=20, xlab="BMI", main="BMI Distribution for Population",col="orange",border = "black")
abline(v=data_98th_percentile, col="red", lty=2)
legend("topright", legend=c("98th percentile"), col="red", lty=2)

hist(sample(bmi, length(bmi), replace=TRUE), breaks=20, xlab="BMI", main="BMI Distribution for Sample", col="lightgreen",border = "black")
abline(v=samp_98th_percentile, col="grey", lty=2)
legend("topright", legend=c("98th percentile"), col="grey", lty=2)
